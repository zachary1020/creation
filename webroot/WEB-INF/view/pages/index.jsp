...
<body class="flat-blue">
    <div class="app-container">
                        ...
                        <li class="dropdown profile">
                            ...
                            <ul class="dropdown-menu animated fadeInDown">
                                <li class="profile-img">
                                    <img src="resources/dist/img/profile/picjumbo.com_HNCK4153_resize.jpg" class="profile-img">
                                </li>
                                <li>
                            ...
                            <div class="card card-success">
                                ...
                                <div class="card-body no-padding">
                                    <ul class="message-list">
                                        <a href="#">
                                            <li>
                                                <img src="/Creation/resources/dist/img/profile/profile-1.jpg" class="profile-img pull-left">
        ...
        <footer class="app-footer">
            <div class="wrapper">
                <span class="pull-right">2.1 <a href="#"><i class="fa fa-long-arrow-up"></i></a></span>  All Rights Reserved, 2016 Copyright.
            </div>
        </footer>
        <div>
<script type="text/javascript" src="/Creation/resources/dist/js/index.js"></script>
</body>
